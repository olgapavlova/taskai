...
## Теория
`01` • [Усвоить теорию](<steps/01 • Усвоить теорию.md>). Проработать книгу или статью, законспектировать лекцию. Иногда — написать и упорядочить теорию самостоятельно. «Загрузить» в себя связное знание и зафиксировать его на бумаге.

`02` • [Вписать теорию в реальность](<steps/02 • Вписать теорию в реальность.md>). Особенно тщательно зафиксировать ответы на вопросы «Зачем это всё знать и изучать?» и «В какой контекст вписывается эта информация?». Придумать примеры. Структура и аннотации автора теории тут могут и не особо помогать.

`03` • [Разметить точки прокачки](<steps/03 • Разметить точки прокачки.md>). Места в теории, требующие поддержки задачами. Иначе говоря, точки, где у пользователя теории возникают трудности в освоении. И пример не помогает. Таким образом поток задач становится чем-то вроде интеллектуального helpdesk’а или support’а — службы, которая помогает разобраться в ситуации и всё наладить (в голове и в руках).

## Навыки
`04` • [Точечно зафиксировать навыки](<steps/04 • Точечно зафиксировать навыки.md>). Записать, что именно должны прорабатывать задачи в точках прокачки. Какие именно навыки.

`05` • [Понять, зачем тут навык](<steps/05 • Понять, зачем тут навык.md>). Зафиксировать, зачем прорабатывать этот конкретный навык в каждой точке. Попутно понять контекст этого навыка: он нам нужен для того, чтобы понять что-то дальше? Или это прикладной навык, полезный в работе? А может, общая эрудиция? А может, вообще что-то общефилософское или soft?

`06` • [Типизировать задачи](<steps/06 • Типизировать задачи.md>). Решить, какого типа задачи должны быть в точке прокачки, чтобы проработать навык. А какого типа задачи вообще бывают, кстати?

## Сырьё
`07` • [Придумать сырьё](<steps/07 • Придумать сырьё.md>). Для каждой задачи придумать, из какого сырья будем её создавать. Какие куски «реального мира» нужно «добыть», чтобы на их основе создать задачу.

`08` • [Классифицировать сырьё](<steps/08 • Классифицировать сырьё.md>). Или, что то же, классифицировать задачи по типу необходимого сырья. Сырьё редко ищут под одну задачу, чаще под класс.

`09` • [Собрать сырьё](<steps/09 • Собрать сырьё.md>). Для каждого класса задач. Приводить в порядок не нужно, тут главное — много однородного сырья.
